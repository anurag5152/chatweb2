    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0D1117] relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col sm:flex-row items-center justify-between w-full max-w-6xl px-6 py-10">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl font-bold text-[#E6EDF3]">Start Conversations That Matter.</h1>
        ...
        >
          <div className="flex flex-col items-center">
            ...
            <h1 className="text-2xl font-bold text-[#E6EDF3] text-center">Create Your Account</h1>
            <p className="mt-2 text-center text-[#8B949E]">Join now and get started instantly</p>
          </div>

          <form onSubmit={handleSubmit} className="mt-8 space-y-5" autoComplete="off">
            <div>
              <label className="block text-sm font-medium text-[#E6EDF3]">Name</label>
              <input
                name="name"
                type="text"
                required
